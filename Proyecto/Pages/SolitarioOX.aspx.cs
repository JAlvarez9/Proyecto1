...
namespace Proyecto.Pages
{
    public partial class SolitarioOX : System.Web.UI.Page
    {
                ...
                if (turnoactual == "player1")
                {
                    for (int i = 0; i < fila; i++)
                    {
                        for (int j = 0; j < columnas; j++)
                        {
                            if (clickedButton.ID == botones[i, j].ID)
                            {
                                MovimientoJugador1((int)tablero[i, j].y, tablero[i, j].x1, tablero[i, j]);
                            }
                        }
                    }
        ...
        public void MovimientoJugador1(int y, int x, Ficaha nueva)
        {
                ...
                for (int j = x - 1; j <= x + 1; j++)
                {
                    ...
                    try
                    {
                        ...
                        else if (jugador2.colors.Contains(tablero[i, j].color))
                        {
                            ...
                            {
                                //Label3.Text = "UL";
                                move = RecursivoJugador1(i, j, "UL");
                            }
                            else if (i == y && j == x - 1)
                            {
                                //Label3.Text = "L";
                                move = RecursivoJugador1(i, j, "L");
                            }
                            else if (i == y + 1 && j == x - 1)
                            {
                                //Label3.Text = "DL";
                                move = RecursivoJugador1(i, j, "DL");
                            }
                            else if (i == y - 1 && j == x)
                            {
                                //Label3.Text = "U";
                                move = RecursivoJugador1(i, j, "U");
                            }
                            else if (i == y + 1 && j == x)
                            {
                                //Label3.Text = "D";
                                move = RecursivoJugador1(i, j, "D");
                            }
                            else if (i == y - 1 && j == x + 1)
                            {
                                //Label3.Text = "UR";
                                move = RecursivoJugador1(i, j, "UR");
                            }
                            else if (i == y && j == x + 1)
                            {
                                //Label3.Text = "R";
                                move = RecursivoJugador1(i, j, "R");
                            }
                            else if (i == y + 1 && j == x + 1)
                            {
                                //Label3.Text = "DR";
                                move = RecursivoJugador1(i, j, "DR");
                            }
        ...
        public Boolean MovimientoJugador2_2(int y, int x, Ficaha nueva)
        {
            Boolean move = false;
            Boolean yes = false;
            Boolean next = false;
                ...
                for (int j = x - 1; j <= x + 1; j++)
                {
                    ...
                    try
                    {
                        ...
                        else if (jugador1.colors.Contains(tablero[i, j].color))
                        {
                            ...
                            {
                                //Label3.Text = "UL";
                                move = RecursivoJugador2(i, j, "UL");
                            }
                            else if (i == y && j == x - 1)
                            {
                                //Label3.Text = "L";
                                move = RecursivoJugador2(i, j, "L");
                            }
                            else if (i == y + 1 && j == x - 1)
                            {
                                //Label3.Text = "DL";
                                move = RecursivoJugador2(i, j, "DL");
                            }
                            else if (i == y - 1 && j == x)
                            {
                                //Label3.Text = "U";
                                move = RecursivoJugador2(i, j, "U");
                            }
                            else if (i == y + 1 && j == x)
                            {
                                //Label3.Text = "D";
                                move = RecursivoJugador2(i, j, "D");
                            }
                            else if (i == y - 1 && j == x + 1)
                            {
                                //Label3.Text = "UR";
                                move = RecursivoJugador2(i, j, "UR");
                            }
                            else if (i == y && j == x + 1)
                            {
                                //Label3.Text = "R";
                                move = RecursivoJugador2(i, j, "R");
                            }
                            else if (i == y + 1 && j == x + 1)
                            {
                                //Label3.Text = "DR";
                                move = RecursivoJugador2(i, j, "DR");
                            }
                            if (move)
                            {
        ...
        public Boolean RecursivoJugador1(int y1, int x1, string D)
        {
            ...
            {
                moves = RecursivoJugador1(posi.Item1, posi.Item2, D);
            }
        ...
        public Boolean RecursivoJugador2(int y1, int x1, string D)
        {
            int y = y1;
            int x = x1;
            var posi = new Tuple<int, int>(y, x);
            ...
            {
                moves = RecursivoJugador2(posi.Item1, posi.Item2, D);
            }
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            if (firstmoves < 4 & apertura == true)
            {
                if(turnoactual == "player2")
                {
                    Boolean salir = false;
                    for (int i = enmedioY-1; i <= enmedioY; i++)
                    {
                        for (int j = enmedioX-1; j <= enmedioX; j++)
                        {
                    ...
                    for (int i = 0; i < fila; i++)
                    {
                        for (int j = 0; j < columnas; j++)
                        {
                            if (tablero[i, j].llenado == false)
                            {
                                ...
                                salir = MovimientoJugador2_2((int)tablero[i, j].y, tablero[i, j].x1, tablero[i, j]);
                                if (salir)
                                {
                                    break;
                                }
